...
export default function Nav({ show }) {
  ...
  return (
    <div className={(show ? 'left-0' : '-left-full') + " top-0 grey_text bg-white p-4 fixed w-full  min-h-screen md:static md:w-auto transition-all z-[3]"}>
      <div className="mb-4 flex items-center justify-center w-full auto ">
        <h3>ZENBOARD</h3>
      </div>
